...
struct vertex_property_map_generator_helper<Graph, IndexMap, Value, true> {
  ...
  static type                                            build(
    ...
    std::fill(
        array_holder.get(), array_holder.get() + num_vertices(g), Value());
...
struct vertex_property_map_generator {
  typedef boost::is_base_and_derived<
      ...
      known_num_vertices;
  typedef vertex_property_map_generator_helper<
      Graph,
      IndexMap,
      Value,
...
struct default_color_map_generator {
  typedef boost::is_base_and_derived<
      ...
      typename boost::graph_traits<Graph>::traversal_category>
      known_num_vertices;
  typedef default_color_map_generator_helper<
      Graph,
      IndexMap,
      known_num_vertices::value>
                                helper;
...
inline void dijkstra_shortest_paths_no_init(
    ...
    DistZero                                        zero,
    DijkstraVisitor                                 vis) {
  typedef detail::default_color_map_generator<Graph, IndexMap> ColorMapHelper;
...
template<
    ...
    class IndexMap,
    class Params>
inline void dijkstra_dispatch2(
    const VertexListGraph&                                    g,
    typename graph_traits<VertexListGraph>::vertex_descriptor s,
    DistanceMap                                               distance,
    WeightMap                                                 weight,
  ...
  dijkstra_shortest_paths(
      ...
      choose_param(
          get_param(params, distance_inf_t()), (std::numeric_limits<D>::max)()),
...
template<
    ...
    class IndexMap,
    class Params>
inline void dijkstra_dispatch1(
    const VertexListGraph&                                    g,
    typename graph_traits<VertexListGraph>::vertex_descriptor s,
    DistanceMap                                               distance,
    WeightMap                                                 weight,
